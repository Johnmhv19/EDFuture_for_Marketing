...
CREATE TABLE "new_ProgrammeFile" (
    ...
    "uploadedByRole" TEXT NOT NULL DEFAULT 'admin',
...
INSERT INTO "new_ProgrammeFile" ("caption", "category", "displayName", "id", "isPublic", "mimeType", "originalName", "programmeId", "sizeBytes", "status", "storageKey", "type", "uploadedAt", "uploadedBy", "url") SELECT "caption", "category", "displayName", "id", "isPublic", "mimeType", "originalName", "programmeId", "sizeBytes", "status", "storageKey", "type", "uploadedAt", "uploadedBy", "url" FROM "ProgrammeFile";
